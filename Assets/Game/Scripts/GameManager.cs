...
public class GameManager : NetworkBehaviour
{
    ...
    public struct Line
    {
        public List<Vector2Int> gridVectorList;
    ...
    private void Awake()
    {
        ...
        lineList = new List<Line>
        {
            ...
            new Line
            {
                gridVectorList = new List<Vector2Int>{ new Vector2Int(0, 0), new Vector2Int(1, 0), new Vector2Int(2, 0) },
                centerGridPosition = new Vector2Int(1, 0),
                orientation = Orientation.Vertical
            },
            new Line
            {
                gridVectorList = new List<Vector2Int>{ new Vector2Int(0, 1), new Vector2Int(1, 1), new Vector2Int(2, 1) },
                centerGridPosition = new Vector2Int(1, 1),
                orientation = Orientation.Vertical
            },
            new Line
            {
                gridVectorList = new List<Vector2Int>{ new Vector2Int(0, 2), new Vector2Int(1, 2), new Vector2Int(2, 2) },
            ...
            new Line
            {
                gridVectorList = new List<Vector2Int>{ new Vector2Int(0, 0), new Vector2Int(0, 1), new Vector2Int(0, 2) },
                centerGridPosition = new Vector2Int(0, 1),
                orientation = Orientation.Horizontal
            },
            new Line
            {
                gridVectorList = new List<Vector2Int>{ new Vector2Int(1, 0), new Vector2Int(1, 1), new Vector2Int(1, 2) },
                centerGridPosition = new Vector2Int(1, 1),
                orientation = Orientation.Horizontal
            },
            new Line
            {
                gridVectorList = new List<Vector2Int>{ new Vector2Int(2, 0), new Vector2Int(2, 1), new Vector2Int(2, 2) },
            ...
            new Line
            {
                gridVectorList = new List<Vector2Int>{ new Vector2Int(0, 0), new Vector2Int(1, 1), new Vector2Int(2, 2) },
                centerGridPosition = new Vector2Int(1, 1),
                orientation = Orientation.DiagonalA
            },
            new Line
            {
                gridVectorList = new List<Vector2Int>{ new Vector2Int(0, 2), new Vector2Int(1, 1), new Vector2Int(2, 0) },
                centerGridPosition = new Vector2Int(1, 1),
    ...
    {
        Debug.Log("ClickedOnGridPosition " + x + ", " + y + " playerType: " + playerType);
    ...
    private bool TestWinnerLine(Line line)
    {
        return TestWinnerLine(
            playerTypeArray[line.gridVectorList[0].x, line.gridVectorList[0].y],
            playerTypeArray[line.gridVectorList[1].x, line.gridVectorList[1].y],
            playerTypeArray[line.gridVectorList[2].x, line.gridVectorList[2].y]
        );
    }
